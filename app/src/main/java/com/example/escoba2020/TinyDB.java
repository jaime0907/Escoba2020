...
public class TinyDB {
    ...
    public void putListCard(String key, ArrayList<SavedCard> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(SavedCard player: playerList){
    ...
    public ArrayList<SavedCard> getListCard(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<SavedCard> playerList =  new ArrayList<SavedCard>();

        for(String jObjString : objStrings){
            SavedCard player  = gson.fromJson(jObjString,  SavedCard.class);
